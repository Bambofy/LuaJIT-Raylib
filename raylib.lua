...
local raylib = ffi.load("lib/osx/libraylib.2.6.0.dylib");
...
-- Extract from https://github.com/raysan5/raylib/blob/master/src/raylib.h
...
LIME = ffi.new("Color", { 0, 158, 47, 255 }      )
...
VIOLET = ffi.new("Color", { 135, 60, 190, 255 }    )
